...
enum AppPreferenceKey {
    ...
    static let mouseTriggersEnabled = "mouseTriggersEnabled"
    static let mouseTriggerMode = "mouseTriggerMode"
    static let mouseTranscriptionButtonNumber = "mouseTranscriptionButtonNumber"
    static let mouseShortcutCaptureInProgress = "mouseShortcutCaptureInProgress"
