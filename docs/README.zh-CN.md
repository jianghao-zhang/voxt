...
- 当前工程里的依赖源是 Voxt 维护的镜像 fork `hehehai/mlx-audio-swift`，目前固定在 commit `8ae0c745360b32c128c0ba6d4e46b27ee3214529`。依赖策略见 [docs/MLXAudioDependency.md](./MLXAudioDependency.md)。
